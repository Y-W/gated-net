...
@slim.add_arg_scope
def bottleneck_softGated(inputs, depth, depth_bottleneck, stride, isGated=False,
               gateChannelRatio=0.25, rate=1, outputs_collections=None, scope=None):
...
# def resnetV1_softGatedV1_50(inputs,
#                  num_classes=None,
#                  is_training=True,
#                  global_pool=True,
#                  output_stride=None,
#                  reuse=None,
#                  scope='resnetV1_softGatedV1_50'):
#   blocks = [
#       resnet_utils.Block(
...
def resnetV1_softGatedV1_101(inputs,
                  num_classes=None,
                  is_training=True,
                  global_pool=True,
                  output_stride=None,
                  reuse=None,
                  scope='resnetV1_softGatedV1_101'):
