...
from slim_model.datasets import dataset_factory
from slim_model.deployment import model_deploy
from slim_model.nets import nets_factory
from slim_model.preprocessing import preprocessing_factory
...
tf.app.flags.DEFINE_string(
    'model_name', 'resnet_v1_gated_biased_v2', 'The name of the architecture to train.')
      ...
      for end_point in end_points:
          if end_point.endswith('gate_val'):
              tf.losses.compute_weighted_loss(end_points[end_point], 
                            weights=FLAGS.gate_sparsity_weight, scope='sparsity_penalty')
